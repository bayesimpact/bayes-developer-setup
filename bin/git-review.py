...
class _References(typing.NamedTuple):
    ...
    # Default branch no the remote repository.
    default: str
    # Local branch to push and review.
    branch: str
    # Remote name for the reviewed branch.
    remote: str
    # Branch where the changes should be merged into.
    base: str
...
def _request_mr(remote_url: str, message: str, refs: _References, reviewers: Optional[str]) -> None:
...
def _request_pr(message: str, refs: _References, reviewers: Optional[str]) -> None:
